...
public class SoulJars extends JavaPlugin implements Listener, SlimefunAddon {
    ...
    public void onEnable() {
        ...
        itemGroup = new ItemGroup(new NamespacedKey(this, "soul_jars"), CustomItemStack.create(emptyJar.asOne(), "&bSoul Jars", "", "&a> Click to open"));
        ...
        new SlimefunItem(itemGroup, emptyJar, RecipeType.ANCIENT_ALTAR, new ItemStack[] { SlimefunItems.EARTH_RUNE.asOne(), new ItemStack(Material.SOUL_SAND), SlimefunItems.WATER_RUNE.asOne(), new ItemStack(Material.SOUL_SAND), SlimefunItems.NECROTIC_SKULL.asOne(), new ItemStack(Material.SOUL_SAND), SlimefunItems.AIR_RUNE.asOne(), new ItemStack(Material.SOUL_SAND), SlimefunItems.FIRE_RUNE.asOne() }, CustomItemStack.create(emptyJar.asOne(), 3)).register(this);
